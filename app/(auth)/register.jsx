...
export default function RegisterScreen() {
    ...
    const [phone, setPhone] = useState('123456789123');
    const [password, setPassword] = useState('1');
    const [confirmPassword, setConfirmPassword] = useState('1');
    const [address, setAddress] = useState('1 abc st');
    const [customerId, setCustomerId] = useState('1234'); // For existing subscribers only
